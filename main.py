...
@app.post("/api-endpoint", status_code=200)
...
@app.get("/")
async def root():
    return {"message": "Task Receiver Service running. POST /api-endpoint to submit."}
...
async def get_status():
    ...
    return {"message": "Awaiting first task submission to /api-endpoint"}
